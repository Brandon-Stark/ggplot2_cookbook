...
All the default themes that R provides define a scaling factor called `base_size`, which allows us to change the overall font size. A base size of 14 is a much better option for the figure size chosen in this document (5in by 3.5in), and it is what we used in `theme_cow()` throughout this document.
```{r}
